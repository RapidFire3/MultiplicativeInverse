...
int main (int argc, char* argv[])
{
    ...
    MultiplicativeInverse multiInverse;
    ...
    if(argc == 1)
    {
        ...
        for(int rowAxis = 0; rowAxis < rowMax; rowAxis++)
        {
            ...
            {   
                ...
                multiInverse.solveForInverse(number);
                cout << setfill('0') << setw(2) << multiInverse.getInverseValue() << "\t";
                number++;
            }
            cout << endl;
        }
    ...
    else 
    {
        ...
        if( number >= 0 && number < 256 ) {
            cout << "0x" << number << " -> 0x";
            cout << setfill('0') << setw(2) << multiInverse.getInverseValue() << endl;
        }
